...
Character player = {100, 100, 0, 0, false, false, false, 0, 100}; // Initialize the player object
Enemy enemy  = {500, 370, 0, 0, false, false, false, 0, 100, false, 0};

Bending playerbend   = {0,53,53,10,1,110,125,125,nullptr};
Bending enemybend    = {0,53,53,10,1,110,125,125,nullptr};
